...
getWeekDays () {
    ...
    customRRuleGenerate() {
        ...
        let that = this;
        var repeatIntervalType = $('#selectrepeat');
    ...
    RepeatUntil() {
console.log("Rpeat calling");
        let that = this;
        var repeatIntervalType = $('#selectpopup');
        var repeatIntervalValue = $('#repeatIntervalValue');
        var rruleWeeklyButtons = $("input[name='weekdaysd']:checked");
        var rruleMonthlyPanel = $('.rrule-monthly');
      
        var rruleEndAction       = $("input[name='drruleEndAction']:checked");
        var rruleEndSessionsCount = $('#drruleEndSessionsCount'); 
       ...
       GlobalData.gRRULE = rule.toString();
       console.log(rule.toString())
