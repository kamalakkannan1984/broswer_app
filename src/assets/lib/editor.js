			...
			var menuItems = { 'fonteffects': true,
						...
						'insert_table'	: { "modal": true,
											...
											"onSave": function(){
												...
												if( (tblRows == "0") || (tblColumns == "0") )
												{
													methods.showMessage.apply(this,["tblErrMsg","Rows or column value must be a greater then  0"]);
													return false;
												}
												if( (parseInt(tblRows) > 11 ) || (parseInt(tblColumns) > 11) )
												{
													methods.showMessage.apply(this,["tblErrMsg","Rows or column value must be a less then   1000"]);
													return false;
												}
												...
												if( (tblWidth == "0") || (tblHeight == "0") )
												{
													methods.showMessage.apply(this,["tblErrMsg","Width or height must be a greater then  10"]);
													return false;
												}
												if( (parseInt(tblWidth) > 801 ) || (parseInt(tblHeight) > 11) )
												{
													methods.showMessage.apply(this,["tblErrMsg","Width or height must be a lessthen   800"]);
													return false;
												}
												...
												{
													methods.showMessage.apply(this,["tblErrMsg","Border size must be a valid number"]);
													return false;
												}
												else if( (parseInt(tblBorder) > 26 ) )
												{
													methods.showMessage.apply(this,["tblErrMsg","Border size must be a lessthen 25"]);
													return false;
												}
												...
												else if(tblCellspacing == "0")
												{
													methods.showMessage.apply(this,["tblErrMsg","Cell spacing must be a valid number"]);
													return false;
												}
												else if( (parseInt(tblCellspacing) > 26 ) )
												{
													methods.showMessage.apply(this,["tblErrMsg","Cell spacing  must be a lessthen 25"]);
													return false;
												}
												...
												else if(tblCellpadding == "0")
												{
													methods.showMessage.apply(this,["tblErrMsg","Cell padding must be a valid number"]);
													return false;
												}
												else if( (parseInt(tblCellpadding) > 26 ) )
												{
													methods.showMessage.apply(this,["tblErrMsg","Cell padding must be a lessthen 25"]);
													return false;
												}
