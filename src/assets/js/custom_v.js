...
// ***************** POP UP DIV SHOW HIDE STARTS HERE
$(document).ready(function () {
  $("select#selectrepeat")
    .change(function () {
      $(this)
...
// ***************** POP UP DIV SHOW HIDE JS STARTS HERE
// ***************** ADD CLASS TO CHAT SCREEN MESSAGES SELECTED CLASS ************
// $(".formsgoption").click(function() {
//     $(".chat-msg").addClass('cht-selected');
// });
$(".formsgoption").on("click", function () {
...
// ***************** OPEN POPUP BASED ON SELECT  OPTION
$("#selectprtuntilpopid").change(function () {
  var opval = $(this).val();
...
$(document).ready(function () {
  $(".share-file-sec").mouseover(function () {
    $(".share-file-drive-sec").css("display", "block");
  });
});
$("body").click(function (evt) {
  $(".share-file-drive-sec").css("display", "none");
});
